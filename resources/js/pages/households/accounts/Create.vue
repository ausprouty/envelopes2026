...
function submit() {
    form.post(`/households/${props.household.id}/accounts`);
}
</script>

<template>
    <Head title="Add Financial Account" />

    <div class="min-h-screen bg-gray-50">
        <div class="mx-auto max-w-3xl px-4 py-8 sm:px-6 lg:px-8">
            <div class="mb-6">
                <Link
                    :href="`/households/${household.id}/accounts`"
            ...
            >
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <p
                            v-if="form.errors.account_reference"
                            class="mt-1 text-sm text-red-600"
                        >
                    ...
                    <div>
                        ...
                        <p
                            v-if="form.errors.warning_balance"
                            class="mt-1 text-sm text-red-600"
                        >
